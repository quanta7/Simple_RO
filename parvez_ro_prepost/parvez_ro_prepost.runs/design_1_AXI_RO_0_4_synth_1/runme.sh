...
HD_PWD='C:/Tutorials/Vivado/parvez_ro_prepost/parvez_ro_prepost.runs/design_1_AXI_RO_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_RO_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_RO_0_4.tcl
