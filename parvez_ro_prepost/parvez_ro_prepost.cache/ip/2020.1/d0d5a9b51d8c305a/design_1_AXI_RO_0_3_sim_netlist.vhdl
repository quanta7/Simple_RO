...
\RO[1].notGate[0].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__6\
     port map (
      in_sig => w(6),
      out_sig => w(7)
    );
\RO[1].notGate[1].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__7\
     port map (
      in_sig => w(7),
      out_sig => w(8)
    );
\RO[1].notGate[2].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__8\
     port map (
      in_sig => w(8),
      out_sig => w(9)
    );
\RO[1].notGate[3].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__9\
     port map (
      in_sig => w(9),
      out_sig => w(10)
    );
\RO[1].notGate[4].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__10\
     port map (
      in_sig => w(10),
      out_sig => w(11)
    );
...
\RO[2].notGate[0].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__11\
     port map (
      in_sig => w(12),
      out_sig => w(13)
    );
\RO[2].notGate[1].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__12\
     port map (
      in_sig => w(13),
      out_sig => w(14)
    );
\RO[2].notGate[2].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__13\
     port map (
      in_sig => w(14),
      out_sig => w(15)
    );
\RO[2].notGate[3].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__14\
     port map (
      in_sig => w(15),
      out_sig => w(16)
    );
\RO[2].notGate[4].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__15\
     port map (
      in_sig => w(16),
      out_sig => w(17)
    );
...
\RO[3].notGate[0].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__16\
     port map (
      in_sig => w(18),
      out_sig => w(19)
    );
\RO[3].notGate[1].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__17\
     port map (
      in_sig => w(19),
      out_sig => w(20)
    );
\RO[3].notGate[2].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__18\
     port map (
      in_sig => w(20),
      out_sig => w(21)
    );
\RO[3].notGate[3].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__19\
     port map (
      in_sig => w(21),
      out_sig => w(22)
    );
\RO[3].notGate[4].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__20\
     port map (
      in_sig => w(22),
      out_sig => w(23)
    );
...
\RO[4].notGate[0].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__21\
     port map (
      in_sig => w(24),
      out_sig => w(25)
    );
\RO[4].notGate[1].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__22\
     port map (
      in_sig => w(25),
      out_sig => w(26)
    );
\RO[4].notGate[2].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__23\
     port map (
      in_sig => w(26),
      out_sig => w(27)
    );
\RO[4].notGate[3].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__24\
     port map (
      in_sig => w(27),
      out_sig => w(28)
    );
\RO[4].notGate[4].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__25\
     port map (
      in_sig => w(28),
      out_sig => w(29)
    );
\RO[5].nolabel_line95\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_one2two_4
     port map (
      input1 => w(35),
      output1 => w(30),
      output2 => input_signal(5)
    );
\RO[5].notGate[0].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__26\
     port map (
      in_sig => w(30),
      out_sig => w(31)
    );
\RO[5].notGate[1].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__27\
     port map (
      in_sig => w(31),
      out_sig => w(32)
    );
\RO[5].notGate[2].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__28\
     port map (
      in_sig => w(32),
      out_sig => w(33)
    );
\RO[5].notGate[3].Inverter\: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT__29\
     port map (
      in_sig => w(33),
      out_sig => w(34)
    );
\RO[5].notGate[4].Inverter\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LUT6_NOT
     port map (
      in_sig => w(34),
      out_sig => w(35)
    );
frequency_counter_instance: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_frequency_counter
     port map (
      Q(191 downto 0) => frequency_counter_wire(191 downto 0),
      in_signal(5 downto 0) => input_signal(5 downto 0),
      s00_axi_aclk => s00_axi_aclk
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_AXI_RO_0_3,AXI_RO_v1_0,{}";
