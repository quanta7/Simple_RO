...
HD_PWD='C:/Tutorials/Vivado/simple_RO_post_stress/simple_RO_post_stress.runs/design_1_AXI_RO_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_RO_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_RO_1_0.tcl
