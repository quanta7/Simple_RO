...
// Instantiation of Axi Bus Interface S00_AXI
	AXI_BTI_2_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) AXI_BTI_2_v1_0_S00_AXI_inst (
    ...
    begin : RO
        (*DONT_TOUCH= "true"*) assign w[j*num_stages+j] = 1;
        //(*DONT_TOUCH= "true"*) LUT6_NOT1 Inverter(.out_sig(w[j*num_stages+1+j]));
